...
class AdvancedRateLimiter {
    ...
    check(identifier) {
        ...
        return {
            allowed: true,
            remainingRequests: Math.min(this.config.maxRequestsPerSecond - lastSecond - 1, this.config.maxRequestsPerMinute - lastMinute - 1, this.config.maxRequestsPerHour - lastHour - 1),
            resetAt: now + 1000,
            blocked: false
        };
    }
