...
class AnomalyDetector {
    ...
    recordSigning(validatorAddress, slot, latencyMs, success) {
        const alerts = [];
    ...
    checkHighFrequency(validatorAddress, metrics) {
        const now = Date.now();
    ...
    checkRepeatedFailures(validatorAddress, metrics) {
        const now = Date.now();
    ...
    checkLatencyAnomaly(validatorAddress, latencyMs) {
    ...
    checkDoubleSigningAttempt(validatorAddress, slot, metrics) {
    ...
    getAlerts(validatorAddress, since) {
