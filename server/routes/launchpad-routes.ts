...
router.get("/projects/:id", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch project details" });
  }
});
...
router.get("/projects/:id/rounds", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch project rounds" });
  }
});
...
router.get("/projects/:id/activity", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch project activity" });
  }
});
...
router.get("/rounds/active", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch active rounds" });
  }
});
...
router.get("/whitelist/:projectId/:walletAddress", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch whitelist status" });
  }
});
...
router.get("/allocations/:walletAddress", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch user allocations" });
  }
});
...
router.get("/vesting/:walletAddress", async (req: Request, res: Response) => {
  try {
    ...
    res.status(503).json({ error: "Failed to fetch user vesting" });
  }
});
