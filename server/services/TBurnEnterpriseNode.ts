...
// Removed old /api/consensus/current endpoint - see new one below
  ...
  getPublicBridgeChains(): Array<{
    ...
    return [
      { id: "tburn-mainnet", chainId: 5800, name: "TBURN Mainnet", symbol: "TBURN", nativeCurrency: "TBURN", status: "active", avgBlockTime: 100, confirmationsRequired: 1, totalLiquidity: "1000000000000000000000000000", volume24h: String(50000000000000000000000n + (seedBigInt % 1000000000000000000n)), txCount24h: 15847 + (seedValue % 500) + hourVariance * 10, avgTransferTime: 5000, successRate: 9998, aiRiskScore: 50, isEvm: true },
  ...
  getPublicBridgeRoutes(): Array<{
    ...
    return [
      { id: "route-001", sourceChainId: 1, destinationChainId: 5800, tokenSymbol: "TBURN", routeType: "lock-mint", status: "active", minAmount: "1000000000000000000", maxAmount: "1000000000000000000000000", feePercent: 30, estimatedTime: 180000, successRate: 9995, volume24h: String(BigInt(5000000000000000000000n) + BigInt(seedValue % 100000000000000000n)), liquidityAvailable: "50000000000000000000000", aiOptimized: true, aiPriority: 95 },
      { id: "route-002", sourceChainId: 5800, destinationChainId: 1, tokenSymbol: "TBURN", routeType: "burn-unlock", status: "active", minAmount: "1000000000000000000", maxAmount: "1000000000000000000000000", feePercent: 30, estimatedTime: 180000, successRate: 9993, volume24h: String(BigInt(4500000000000000000000n) + BigInt(seedValue % 90000000000000000n)), liquidityAvailable: "45000000000000000000000", aiOptimized: true, aiPriority: 93 },
      { id: "route-003", sourceChainId: 56, destinationChainId: 5800, tokenSymbol: "TBURN", routeType: "lock-mint", status: "active", minAmount: "1000000000000000000", maxAmount: "500000000000000000000000", feePercent: 25, estimatedTime: 60000, successRate: 9997, volume24h: String(BigInt(3500000000000000000000n) + BigInt(seedValue % 70000000000000000n)), liquidityAvailable: "35000000000000000000000", aiOptimized: true, aiPriority: 92 },
      { id: "route-004", sourceChainId: 5800, destinationChainId: 56, tokenSymbol: "TBURN", routeType: "burn-unlock", status: "active", minAmount: "1000000000000000000", maxAmount: "500000000000000000000000", feePercent: 25, estimatedTime: 60000, successRate: 9996, volume24h: String(BigInt(3200000000000000000000n) + BigInt(seedValue % 64000000000000000n)), liquidityAvailable: "32000000000000000000000", aiOptimized: true, aiPriority: 91 },
      { id: "route-005", sourceChainId: 137, destinationChainId: 5800, tokenSymbol: "TBURN", routeType: "lock-mint", status: "active", minAmount: "1000000000000000000", maxAmount: "300000000000000000000000", feePercent: 20, estimatedTime: 300000, successRate: 9992, volume24h: String(BigInt(2800000000000000000000n) + BigInt(seedValue % 56000000000000000n)), liquidityAvailable: "28000000000000000000000", aiOptimized: true, aiPriority: 88 },
      { id: "route-006", sourceChainId: 42161, destinationChainId: 5800, tokenSymbol: "TBURN", routeType: "lock-mint", status: "active", minAmount: "1000000000000000000", maxAmount: "500000000000000000000000", feePercent: 15, estimatedTime: 2000, successRate: 9998, volume24h: String(BigInt(4200000000000000000000n) + BigInt(seedValue % 84000000000000000n)), liquidityAvailable: "42000000000000000000000", aiOptimized: true, aiPriority: 96 },
      { id: "route-007", sourceChainId: 5800, destinationChainId: 42161, tokenSymbol: "TBURN", routeType: "burn-unlock", status: "active", minAmount: "1000000000000000000", maxAmount: "500000000000000000000000", feePercent: 15, estimatedTime: 2000, successRate: 9997, volume24h: String(BigInt(3800000000000000000000n) + BigInt(seedValue % 76000000000000000n)), liquidityAvailable: "38000000000000000000000", aiOptimized: true, aiPriority: 94 },
      { id: "route-008", sourceChainId: 10, destinationChainId: 5800, tokenSymbol: "TBURN", routeType: "lock-mint", status: "active", minAmount: "1000000000000000000", maxAmount: "300000000000000000000000", feePercent: 18, estimatedTime: 3000, successRate: 9994, volume24h: String(BigInt(2500000000000000000000n) + BigInt(seedValue % 50000000000000000n)), liquidityAvailable: "25000000000000000000000", aiOptimized: true, aiPriority: 89 }
    ];
  }
  ...
  getPublicBridgeActivity(): Array<{
    ...
    return [
      { id: "act-001", eventType: "transfer_completed", chainId: 5800, walletAddress: addressFromString('tburn-wallet-user-001'), amount: "50000000000000000000000", tokenSymbol: "TBURN", txHash: `th1${dateSeed.slice(0, 64)}`, createdAt: new Date(now - 60000).toISOString() },
      ...
      { id: "act-003", eventType: "liquidity_added", chainId: 5800, walletAddress: addressFromString('tburn-wallet-user-002'), amount: "100000000000000000000000", tokenSymbol: "TBURN", txHash: `th1${dateSeed.slice(8, 72)}`, createdAt: new Date(now - 180000).toISOString() },
