  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gray-50 dark:bg-transparent transition-colors">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{t('publicPages.useCases.stablecoins.sections.types')}</h2>
            <p className="text-gray-600 dark:text-gray-400">{t('publicPages.useCases.stablecoins.sections.typesDesc')}</p>
          </div>
      ...
      <section className="py-20 px-6 bg-gray-100 dark:bg-white/[0.02] border-y border-gray-200 dark:border-white/5">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">{t('publicPages.useCases.stablecoins.sections.platformFeatures')}</h2>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">{t('publicPages.useCases.stablecoins.sections.useCases')}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {useCases.map((useCase, idx) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">{useCase.title}</h3>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-5xl">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-center mb-12">High-throughput infrastructure for stablecoin operations</p>
          ...
          <div className="mt-8 spotlight-card rounded-xl p-6 border border-gray-300 dark:border-white/10">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Example: Stablecoin Transfer (tb1 Format)</h3>
            <pre className="bg-gray-900 text-green-400 p-4 rounded-lg text-sm overflow-x-auto font-mono">
{`// TBURN Stablecoin Transfer
const payment = {
  from: "tb1qtreasury8sdfk3nfjkw8ehjfk3nfkw8sdfj2n",
  to: "tb1qmerchant3kjf8w3nfksd8fjkw3nfksd8fjk4m",
  amount: "50000.00",
  currency: "TUSD",
  chainId: 5800,
  blockTime: "100ms"
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="spotlight-card rounded-2xl p-8 border border-[#00ff9d]/30 text-center"
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">{t('publicPages.useCases.stablecoins.cta.title')}</h2>
