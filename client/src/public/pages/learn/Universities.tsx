    ...
    <div ref={containerRef} className="min-h-screen">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Education at Scale</h2>
            <p className="text-gray-400">Resources and support for the academic community.</p>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-5xl">
          <div className="spotlight-card rounded-2xl p-1 relative overflow-hidden" data-testid="educators-section">
            <div className="absolute inset-0 bg-gradient-to-r from-[#7000ff]/10 to-[#00f0ff]/10 pointer-events-none" />
            
            <div className="bg-black/80 backdrop-blur-xl rounded-xl p-10 md:p-12 relative z-10 flex flex-col md:flex-row items-center gap-10">
              <div className="flex-1">
                <div className="inline-block px-3 py-1 rounded bg-[#7000ff]/20 text-[#7000ff] text-xs font-bold mb-4">
                  FACULTY ACCESS
                </div>
                <h2 className="text-3xl font-bold text-white mb-4">For Educators</h2>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row gap-12 items-start">
            <div className="md:w-1/3">
              <h2 className="text-3xl font-bold text-white mb-6">Student Opportunities</h2>
              <p className="text-gray-400 mb-6 leading-relaxed">
            ...
            <div className="md:w-2/3 grid gap-4">
              {studentOpportunities.map((opportunity, index) => (
                <div 
                  key={index}
                  className="spotlight-card p-6 rounded-xl flex items-center gap-6 group cursor-pointer"
                  data-testid={`opportunity-${index}`}
                >
                  <div 
                    className="text-4xl font-bold text-white/20 font-mono transition-colors"
                    style={{ 
