        ...
        <div className="spotlight-card rounded-xl p-8 md:p-12 text-gray-300">
          ...
          <div className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-3">
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.definitions.items.tburnChain.term')}</strong> {t('publicPages.legal.terms.sections.definitions.items.tburnChain.desc')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.definitions.items.services.term')}</strong> {t('publicPages.legal.terms.sections.definitions.items.services.desc')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.definitions.items.user.term')}</strong> {t('publicPages.legal.terms.sections.definitions.items.user.desc')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.definitions.items.project.term')}</strong> {t('publicPages.legal.terms.sections.definitions.items.project.desc')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.definitions.items.trustScore.term')}</strong> {t('publicPages.legal.terms.sections.definitions.items.trustScore.desc')}</li>
            </ul>
          </div>
          ...
          <div className="mb-12">
            ...
            <h3 className="text-xl font-bold text-white mt-6 mb-3">{t('publicPages.legal.terms.sections.account.creation.title')}</h3>
            <p className="mb-6">{t('publicPages.legal.terms.sections.account.creation.content')}</p>

            <h3 className="text-xl font-bold text-white mt-6 mb-3">{t('publicPages.legal.terms.sections.account.wallet.title')}</h3>
          ...
          <div className="mb-12">
            ...
            <h3 className="text-xl font-bold text-white mt-6 mb-3">{t('publicPages.legal.terms.sections.trustVerification.process.title')}</h3>
            <ul className="list-disc pl-6 space-y-2 mb-6">
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.trustVerification.process.stage1.label')}</strong> {t('publicPages.legal.terms.sections.trustVerification.process.stage1.value')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.trustVerification.process.stage2.label')}</strong> {t('publicPages.legal.terms.sections.trustVerification.process.stage2.value')}</li>
              <li><strong className="text-white">{t('publicPages.legal.terms.sections.trustVerification.process.stage3.label')}</strong> {t('publicPages.legal.terms.sections.trustVerification.process.stage3.value')}</li>
            </ul>

            <h3 className="text-xl font-bold text-white mt-6 mb-3">{t('publicPages.legal.terms.sections.trustVerification.implications.title')}</h3>
          ...
          <div className="mb-12">
            ...
            <div className="p-6 border border-white/10 rounded-xl bg-black/20 space-y-6">
              <div>
                <h3 className="text-lg font-bold text-white mb-2">{t('publicPages.legal.terms.sections.disclaimers.asIs.title')}</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">{t('publicPages.legal.terms.sections.disclaimers.noAdvice.title')}</h3>
                <p className="text-sm text-gray-400">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">{t('publicPages.legal.terms.sections.disclaimers.limitation.title')}</h3>
          ...
          <div className="mt-16 pt-8 border-t border-white/10">
            <h2 className="text-xl font-bold text-white mb-4">{t('publicPages.legal.terms.contact.title')}</h2>
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  <p className="font-medium text-white group-hover:text-[#10b981] transition">{t('publicPages.legal.common.learn.burnChain.title')}</p>
