...
export const qnaData: QnAItem[] = [
  ...
  },
  {
    ...
    answer: 'AI 기반 번 최적화, 거버넌스 분석, 브릿지 리스크 평가, 이상 탐지, 밸리데이터 스케줄링을 제공합니다. 다중 AI 모델(AI Engine α, β, γ, δ)이 통합되어 있습니다.',
    answerEn: 'Provides AI-based burn optimization, governance analysis, bridge risk assessment, anomaly detection, and validator scheduling. Multiple AI models (AI Engine α, β, γ, δ) are integrated.',
