...
const OFFICIAL_CHANNELS: OfficialChannel[] = [
  ...
  {
    id: "x",
    name: "TBURN X (Twitter)",
    url: "https://x.com/tburnio",
    icon: Twitter,
    category: "social",
    verified: true,
  ...
  },
  {
    id: "discord",
    name: "TBURN Discord",
    url: "https://discord.gg/uaPFkUkfN2",
    icon: SiDiscord,
    category: "community",
    verified: true,
  ...
  },
  {
    id: "youtube",
    name: "TBURN YouTube",
    url: "https://www.youtube.com/@tburnio",
    icon: SiYoutube,
    category: "social",
    verified: true,
  ...
  {
    id: "instagram",
    name: "TBURN Instagram",
    url: "https://www.instagram.com/tburnio/",
    icon: SiInstagram,
    category: "social",
    verified: true,
  ...
  },
  {
    id: "tiktok",
    name: "TBURN TikTok",
    url: "https://www.tiktok.com/@tburnio",
    icon: SiTiktok,
    category: "social",
    verified: true,
  ...
  },
  {
    id: "facebook",
    name: "TBURN Facebook",
    url: "https://www.facebook.com/profile.php?id=61584329147888",
    icon: SiFacebook,
    category: "social",
    verified: true,
    description: "Community page and updates",
  },
  {
    id: "reddit",
    name: "TBURN Reddit",
    url: "https://www.reddit.com/user/Living_Break_8249/",
    icon: SiReddit,
    category: "community",
    verified: true,
  ...
  },
  {
    id: "threads",
    name: "TBURN Threads",
    url: "https://www.threads.com/@tburnio",
    icon: SiThreads,
    category: "social",
    verified: true,
    description: "Thread-based conversations",
  },
  {
    id: "bluesky",
    name: "TBURN Bluesky",
    url: "https://bsky.app/profile/tburnio.bsky.social",
    icon: SiBluesky,
    category: "social",
    verified: true,
