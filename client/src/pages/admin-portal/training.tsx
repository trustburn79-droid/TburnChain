...
export default function TrainingMaterials() {
  ...
  const courses: Course[] = trainingData?.courses || [
    ...
    { id: "4", title: "Triple-Band AI Orchestration Mastery", description: "Configure Multi-Band AI Engine α, β, γ, δ system for optimal consensus", category: "AI Systems", duration: "4h 30m", modules: 12, completedModules: 6, level: "intermediate", enrolled: 534, rating: 4.7, iconName: "Bot" },
