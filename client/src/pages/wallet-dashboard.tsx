        ...
        <div className="space-y-6 py-4">
          ...
          <div className="rounded-lg bg-muted/50 p-4 space-y-2">
            ...
            <ul className="text-xs text-muted-foreground space-y-1">
              ...
              <li>3. {t("walletDashboard.instruction3", "Ensure you're on TBURN Mainnet (Chain ID: 5800)")}</li>
            </ul>
          </div>
        </div>
        <DialogFooter>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {t("walletDashboard.secureGenerationDesc", "A new cryptographic key pair will be generated for your TBURN wallet. This wallet will be on the TBURN Mainnet (Chain ID: 5800).")}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
          ...
          <CardHeader className="pb-2 relative z-10">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30">
                ...
                <Badge variant="outline" className="text-[10px] h-5 border-primary/50">Chain ID: 5800</Badge>
              </div>
            </div>
          </CardHeader>
