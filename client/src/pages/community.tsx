...
export default function Community() {
  ...
  const mockEvents: CommunityEvent[] = [
    ...
    { id: "3", title: "events.hackathon.title", description: "events.hackathon.desc", type: "hackathon", startDate: Math.floor(Date.now() / 1000) + 604800, endDate: Math.floor(Date.now() / 1000) + 777600, participants: 89, rewards: "100,000 TBURN", status: "upcoming", isOnline: false, location: "San Francisco, USA" },
